              ...
              <div class="user-detail">
                  ...
                  <div><span class="user-font">State: </span> <span class="user-font">${element.state}</span></div>
                   ...
                   <div style=" margin-bottom: 1rem; margin-left: 1.5rem !important;  margin:2vh 10vw;" class="partial-sign">
                      <a href= "/Buyer/deleteBuyerUsingEmail.html?userId=${element.email}" class="partial-sign2" style="padding:0.2rem 2.4rem !important;background-color:green; border-radius:15px; color: white !important; font-weight: bolder;text-align: center;" class="nav-link text-dark" id="${element.email}">Delete</a>
                       </div>
                       </div>
                   </div><hr>`
        }
              ...
              <div><span class="user-font">State: </span> <span class="user-font">${element.state}</span></div>
               <div><span class="user-font">LGA: </span> <span class="user-font">${element.localGovernment}</span></div>
                ...
                <div><span class="user-font">Status: </span> <span style="color:red" class="user-font">Not Active</span></div>
                   <div style=" margin-bottom: 1rem; margin-left: 1.5rem !important;  margin:2vh 10vw;" class="partial-sign">
                      <a href= "/Buyer/deleteBuyerUsingEmail.html?userId=${element.email}" class="partial-sign2"  style="padding:0.2rem 2.4rem !important;background-color:green; border-radius:15px; color: white !important; font-weight: bolder;text-align: center;" class="nav-link text-dark"  id="${element.email}">Add back</a>
                       </div>
                       </div>
                   </div><hr>`
        }
