  ...
  .then((pro) => pro.json())
    .then(function (response) {
      ...
      if (response.isSuccess == true) {
        ...
        document.querySelector(
          '#btn'
        ).innerHTML = ` <span class="button__text">Log In</span>
