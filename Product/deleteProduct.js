...
then(response => {console.log((response));
    ...
    if(response.isSuccess == true)
    {
        ...
        dateFrom.textContent = response.data.availabilityDateFrom.toString().substring(0,10);
        dateTo.textContent = response.data.availabilityDateTo.toString().substring(0,10);
    }
    else{
